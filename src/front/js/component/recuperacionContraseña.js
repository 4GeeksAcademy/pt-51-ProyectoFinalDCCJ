        ...
        <div className="col-md-6">
          <div className="card  ">
            <div className="card-header text-center ">
              <h5 className="card-title">Recuperar Contraseña</h5><i class="fa-solid fa-house-medical-circle-check"></i>
            </div>
            <div className="card-body">
              <form onSubmit={formik.handleSubmit}>
                ...
                {formik.touched.email && formik.errors.email ? (
                    <div className="text-danger pb-3 fw-bold">{formik.errors.email}</div>
                  ) : null}
                ...
                {formik.touched.password && formik.errors.password ? (
                    <div className="text-danger pb-3 fw-bold">{formik.errors.password}</div>
                  ) : null}
                ...
                {formik.touched.recoveredpassword && formik.errors.recoveredpassword ? (
                    <div className="text-danger pb-3 fw-bold">{formik.errors.recoveredpassword}</div>
                  ) : null}
