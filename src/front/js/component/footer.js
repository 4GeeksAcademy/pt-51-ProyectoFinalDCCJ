    ...
    <div className="container">
      <div className="row">
        ...
        <div className="col-md-4 d-flex flex-column justify-content-end align-items-end">
          ...
          <div>
            <a href="#"><i className="fab fa-instagram fa-2x me-2 color-text1"></i></a>
            <a href="#"><i className="fab fa-twitter fa-2x me-2 color-text1"></i></a>
            <a href="#"><i className="fab fa-facebook fa-2x me-2 color-text1"></i></a>
          </div>
        </div>
      </div>
    </div>
